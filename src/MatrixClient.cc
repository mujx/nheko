...
void
MatrixClient::deleteEvent(const QString &room_id, const QString &event_id)
{
        QUrlQuery query;
        query.addQueryItem("access_token", token_);
...
void
MatrixClient::editEvent(const QString &room_id, const QString &event_id, const QString &text)
{
        QUrlQuery query;
        query.addQueryItem("access_token", token_);
        ...
        connect(reply, &QNetworkReply::finished, this, [reply, this, room_id, event_id, text]() {
                reply->deleteLater();
